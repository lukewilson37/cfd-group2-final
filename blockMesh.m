...
publish(bloc,vert,inle,outl,tops,bott,obst,filename)
...
function blocks = block(nx,ny,nz,theta)
...
length_b2 = floor(0.2/(tan(theta)*0.6))+1;
...
function publish(blocks,v,inlets,outlets,tops,bottoms,obstacles,filename)
